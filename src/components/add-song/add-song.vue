    ...
    <div class="add-song" v-show="showFlag" @click.stop>
      ...
      <div class="shortcut" v-show="!query">
        ...
        <div class="list-wrapper">
          <scroll :refreshDelay="refreshDelay" ref="songList" v-if="currentIndex === 0" :data="playHistory" class="list-scroll">
...
export default {
  ...
  // playHistory里的元素具有song的所有属性，但并不是song的实例
  computed: {
    ...mapGetters([
      'playHistory'
    ])
  ...
  methods: {
    show() {
      this.showFlag = true
      // 当该组件show的时候,需要refresh Scroll组件
      setTimeout(() => {
    ...
    // 点击某一项播放记录时(点击的是playHistory的某一项元素，它并不是Song的实例，需要new一下)
